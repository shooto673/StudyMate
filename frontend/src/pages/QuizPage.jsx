...
const englishQuestions = [
  ...
  },
  {
    ...
    correct_index: 0,
    correct_answer: "am",
    explanation: "Iのときはamを使います。"
  },
  {
    id: "q3",
    body: "They (   ) my friends.",
    choices: ["am", "is", "are", "be"],
    correct_index: 2,
    correct_answer: "are",
    explanation: "複数主語Theyにはareを使います。"
  },
  {
    id: "q4",
    body: "He is tired. の否定文は？",
    choices: ["He not is tired.", "He is not tired.", "He does not tired.", "He are not tired."],
    correct_index: 1,
    correct_answer: "He is not tired.",
    explanation: "be動詞の否定はbe動詞 + notです。"
  },
  {
    id: "q5",
    body: "You are a student. の疑問文は？",
    choices: ["Do you a student?", "Are you a student?", "Is you a student?", "Does you a student?"],
    correct_index: 1,
    correct_answer: "Are you a student?",
    explanation: "be動詞の疑問文はbe動詞を先頭に出します。"
  }
]
...
const mathQuestions = [
  {
    ...
    correct_index: 2,
    correct_answer: "2",
    explanation: "異符号の足し算は絶対値の差を取り、絶対値が大きい方の符号をつけます。"
  },
  {
    id: "m2",
    body: "(-7) - (-3) = ?",
    ...
    correct_index: 1,
    correct_answer: "-4",
    explanation: "引く負の数は足し算に変わります。(-7)+3=-4です。"
  },
  {
    id: "m3",
    body: "(-4) × (+6) = ?",
    ...
    correct_index: 0,
    correct_answer: "-24",
    explanation: "異符号のかけ算は答えが負になります。4×6=24なので-24です。"
  },
  {
    id: "m4",
    body: "(-12) ÷ (-4) = ?",
    ...
    correct_index: 2,
    correct_answer: "3",
    explanation: "同符号のわり算は答えが正になります。12÷4=3です。"
  },
  {
    id: "m5",
    body: "次のうち、絶対値が最も大きい数は？",
    choices: ["+2", "-5", "+3", "-1"],
    correct_index: 1,
    correct_answer: "-5",
    explanation: "絶対値は符号を取った値です。|-5|=5が最大です。"
  }
]

const choiceLabels = ["A", "B", "C", "D"]

export default function QuizPage({ onNavigate, subject, onComplete }) {
          ...
          {questions.map((_, i) => (
            <div key={i} className="flex items-center">
              ...
              {i < questions.length - 1 && (
                <div className="w-4 h-0.5 bg-[var(--text-muted)] opacity-30" />
              )}
            </div>
          ))}
        </div>
              ...
              {currentQuestion.choices.map((choice, i) => {
                ...
                return (
                  <motion.button
                    ...
                    `}
                    style={!isAnswered && isSelected ? {
                      borderColor: subjectColor,
                      backgroundColor: subjectLightColor
                    } : {}}
        ...
        <div className="flex justify-center">
          {!isAnswered ? (
            <motion.button
              ...
              className={`
                px-8 py-4 rounded-2xl font-bold text-lg w-full max-w-xs transition-all duration-200
                ${selectedChoice !== null
