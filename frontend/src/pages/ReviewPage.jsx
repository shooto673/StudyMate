...
export default function ReviewPage({ onNavigate, subject, answers }) {
          ...
          {questions.map((question, i) => {
            ...
            return (
              ...
              >
                  ...
                  {question.choices.map((choice, j) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && (
                          <span className="ml-auto text-xs text-[var(--text-sub)]">
                            あなたの回答
                          </span>
                        )}
                      </div>
                ...
                {/* Explanation */}
                <div
                  className="p-4 rounded-xl bg-[var(--bg-sub)] border-l-4"
