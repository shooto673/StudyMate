...
import type { Answer } from "./quiz-page"
...
export function ResultsPage({
  ...
  const getMascotMood = (): "happy" | "cheering" | "sad" => {
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <motion.button
              ...
              className="flex items-center justify-center gap-2 rounded-2xl border-2 border-[var(--primary)] bg-white px-6 py-4 font-bold text-[var(--primary)] transition-all hover:bg-[var(--primary-light)]"
            >
            ...
            <motion.button
              ...
              className="flex items-center justify-center gap-2 rounded-2xl border-2 border-[var(--text-muted)] bg-white px-6 py-4 font-bold text-[var(--text-sub)] transition-all hover:border-[var(--text-sub)] hover:bg-[var(--bg-sub)]"
            >
            ...
            <motion.button
              ...
              className="flex items-center justify-center gap-2 rounded-2xl bg-[var(--primary)] px-6 py-4 font-bold text-white shadow-md transition-all hover:shadow-lg"
            >
