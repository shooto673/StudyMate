...
type MascotMood = "normal" | "happy" | "thinking" | "sad" | "cheering" | "surprised" | "studying" | "sleeping"
type MascotCharacter = "mascot" | "mona"
...
// モナちゃん画像URL（ピンクの子猫）
const monaImages: Record<MascotMood, string> = {
...
export function Mascot({
  ...
  const imageUrl = character === "mascot" ? mascotImages[mood] : monaImages[mood]
  ...
  return (
    <div className={cn("relative inline-flex flex-col items-center", className)}>
      ...
      <motion.div
        className={cn(animate && "animate-float")}
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
      >
        <img
          src={imageUrl}
          alt={character === "mascot" ? "テイラーくん" : "モナちゃん"}
          width={pixelSize}
          height={pixelSize}
